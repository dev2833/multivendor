...
import {makeTenPlusOneData,makeStoreList} from '../../services/index'
...
export class TenPlusOne extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <Breadcrumb title="TenPlusOne" parent="Sales" />
...
const mapStateToProps = (state) => ({
    data:makeTenPlusOneData(state.tenPlusOne.tenPlusOnes,false,state.store.currentStore),
