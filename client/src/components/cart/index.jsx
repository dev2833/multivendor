...
class cartComponent extends Component {
    ...
    render (){
        ...
        const {isLogin,cartItems, symbol, total,rate,currency} = this.props;
        return (
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                    ...
                                    {cartItems.map((item, index) => {
                                        ...
                                        <tbody key={index}>
                                            <tr>
                                                ...
                                                <td><h2>{symbol}{(item.price*rate.currency[currency].rate).toFixed(0)}</h2></td>
                                                <td>
                                                    <div className="qty-box">
                                                        <div className="input-group">
                                                ...
                                                <td><h2 className="td-color">{symbol}{(item.sum*rate.currency[currency].rate).toFixed(0)}</h2></td>
                                            </tr>
                                        </tbody> )
                                    })}
                                </table>
                                <table className="table cart-table table-responsive-md">
                                    ...
                                    <tr>
                                        <td>total price :</td>
                                        <td><h2>{symbol} {(total*rate.currency[currency].rate).toFixed(0)} </h2></td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
