...
class CoinListItem extends Component {
    ...
    render() {
        const {rate,currency, product, symbol, onAddToCartClicked, onAddToWishlistClicked, onAddToCompareClicked} = this.props;
        ...
        return (
                    ...
                    <div className="product-box">
                        <div className="img-wrapper">
                            <div className="front">
                                <Link to={`${process.env.PUBLIC_URL}/coin-sidebar/product/${product.id}`} ><img
                        ...
                        <div className="product-detail">
                            <div>
                                ...
                                <Link to={`${process.env.PUBLIC_URL}/coin-sidebar/product/${product.id}`}>
                                {
                                    product.category == "silver"?<h6>{product.weight + " gram silver"}</h6>
                                    :<h6>{product.name+" kt " +product.category +" " + product.weight+"gram"}</h6>
                                }
                                    
                                </Link>
                                {
                                    product.category == "silver"?<h4>{symbol}{(product.price*rate.currency[currency].rate).toFixed(0)}</h4>
                                    :<h4>{symbol}{(product.price*rate.currency[currency].rate).toFixed(0)}</h4>
                                }
