...
class ProductListItem extends Component {
    ...
    render() {
        const {currency,rate,product, symbol, onAddToCartClicked, onAddToWishlistClicked, onAddToCompareClicked} = this.props;
                    ...
                    <div className="product-box">
                        ...
                        <div className="product-detail">
                            <div>
                                ...
                                <h4>{symbol}{(product.price*rate.currency[currency].rate-(product.price*rate.currency[currency].rate*product.discount/100)).toFixed(0)}
                                    <del><span className="money">{symbol}{(product.price*rate.currency[currency].rate).toFixed(0)}</span></del></h4>
                                {product.variants?
