...
class ProductListing extends Component {
    ...
    render (){
        const {currency,rate,products, addToCart, symbol, addToWishlist, addToCompare} = this.props;
...
export default connect(
    mapStateToProps, {addToCart, addToWishlist, addToCompare,getAllProducts}
)(ProductListing)