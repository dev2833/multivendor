...
import TryHomeHistory from '../home/history'
                                ...
                                <div className="dashboard-left">
                                    ...
                                    <div className="block-content">
                                        <ul>
                                            ...
                                            <li className="active"><Link to={`${process.env.PUBLIC_URL}/pages/tryHome`}>My Try_At_Home</Link></li>
