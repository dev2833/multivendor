                                ...
                                <div className="dashboard-left">
                                    ...
                                    <div className="block-content">
                                        <ul>                                            
                                            ...
                                            <li className="active"><Link to={`${process.env.PUBLIC_URL}/pages/wallet`}>My Wallet-Cash</Link></li>
                                ...
                                <div className="dashboard-right">
                                    <div className="dashboard">
                                        <div className="page-title">
                                            <h5>My Wallet Cash</h5>
                                            <hr/>
                                        </div>
                                        <div className="row">
                                            <div className="col-xl-9">
                                            <button onClick={()=>this.setState({})} className="btn btn-info">Recharge Wallet</button>
                                            </div>
                                            <div className="col-xl-3">
                                            <button onClick={()=>this.setState({})} className="btn btn-primary">Transaction History</button>
                                            </div>
                                        </div>
