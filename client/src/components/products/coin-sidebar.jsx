...
import DetailsCoinTabs from "./common/details-coin-tabs";
    ...
    render(){
        ...
        return (
            <div>
                ...
                <Breadcrumb  parent={'Product'} title={item.category} />
...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        item: state.data.coins.find(el => el.id == productId),
        symbol: state.data.symbol
    }
}

export default connect(mapStateToProps, {addToCart, addToCartUnsafe, addToWishlist}) (CoinSideBar);