                        ...
                        <Tabs className="tab-content nav-material">
                            ...
                            <table className="table table-striped mb-0">
                                    <tbody>
                                        <tr>
                                            <th>Type :</th>
                                            <td>{this.props.item.metal.purity +' '+ this.props.item.metal.type}</td>
                                        </tr>
                                        <tr>
                                            <th>Weight :</th>
                                            <td>{this.props.item.metal.weight}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </TabPanel>
                            ...
                            <table className="table table-striped mb-0">
                                    ...
                                    <tr>
                                        <th>0% Making charge :</th>
                                        <td>{this.props.item.offers}</td>
                                    </tr>
                                    <tr>
                                        <th>Discount :</th>
                                        <td>{this.props.item.dicount}</td>
                                    </tr>
                                    <tr>
                                        <th>Gst :</th>
                                        <td>{this.props.item.GST}</td>
                                    </tr>
                                    <tr>
                                        <th>total :</th>
